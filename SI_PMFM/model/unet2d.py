...
#     def __init__(self, num_points=512, conv_inch=512, ext=False, size=None):
#         super().__init__()
#         if size is None:
#             size = [32, 32]
...
#                 nn.BatchNorm2d(conv_inch * 2),
#                 nn.ReLU(inplace=True)
#             )
#             self.conv2 = nn.Sequential(
#                 nn.Conv2d(conv_inch * 2, conv_inch, kernel_size=3, padding=1, stride=1, bias=False),
#                 nn.BatchNorm2d(conv_inch),
#                 nn.ReLU(inplace=True)
#             )
#         self.final_conv = nn.Sequential(
#             nn.Conv2d(conv_inch, self.num_points, kernel_size=3, padding=1, stride=1, bias=False),
#             nn.BatchNorm2d(self.num_points),
#             nn.ReLU(inplace=True)
#         )
#         self.final_fc = nn.Sequential(
#             nn.Linear(size[0] * size[1], 3),
